...
public class DecimalUtils {
	...
	public DecimalUtils percent(Object value) {
		if(value == null )return this;
		BigDecimal percent = convert(value).divide(new BigDecimal(100), Scale.ROUND_34);
		this.value = this.value.multiply(percent, Scale.ROUND_34);
