...
public class Scale {
	...
	public static final MathContext ROUND_0 = new MathContext(0, RoundingMode.HALF_UP);
	public static final MathContext ROUND_1 = new MathContext(1, RoundingMode.HALF_UP);
	public static final MathContext ROUND_2 = new MathContext(2, RoundingMode.HALF_UP);
	public static final MathContext ROUND_3 = new MathContext(3, RoundingMode.HALF_UP);
	public static final MathContext ROUND_4 = new MathContext(4, RoundingMode.HALF_UP);
	public static final MathContext ROUND_5 = new MathContext(5, RoundingMode.HALF_UP);
	public static final MathContext ROUND_6 = new MathContext(6, RoundingMode.HALF_UP);
