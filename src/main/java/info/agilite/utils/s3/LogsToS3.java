...
public class LogsToS3 {
	...
	public static void enviarLog(AmazonS3 s3, String rastreamento, String pid, String schema, String sistema, LogStatus status) throws IOException {
		String data = DateUtils.formatDate(LocalDate.now(), "yyMMdd");
		String key = StringUtils.concat("LOGS/", data, "/", schema, "/", sistema, "/", pid, "_", status.name(), ".log");
